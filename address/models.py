...
class District(Model):
    ...
    dist_code = CharField(_('district code'), max_length=50, unique=True, null=True, blank=True)
...
class SubDistrict(Model):
    ...
    sub_dist_code = CharField(_('subdistrict code'), max_length=50, unique=True, null=True, blank=True)
    governorate = ForeignKey(Governorate,  on_delete=CASCADE, null=True, blank=True)
...
class Village(Model):
    ...
    village_code = CharField(_('village code'), max_length=50, unique=True, null=True, blank=True)
    governorate = ForeignKey(Governorate, on_delete=CASCADE, null=True, blank=True)
    district = ForeignKey(District, on_delete=CASCADE, null=True, blank=True)
...
class SubVillage(Model):
    ...
    sub_village_code = CharField(_('subvillage code'), max_length=50, unique=True, null=True, blank=True)
    governorate = ForeignKey(Governorate, on_delete=CASCADE, null=True, blank=True)
    district = ForeignKey(District, on_delete=CASCADE, null=True, blank=True)
    sub_district = ForeignKey(SubDistrict, on_delete=CASCADE, null=True, blank=True)
